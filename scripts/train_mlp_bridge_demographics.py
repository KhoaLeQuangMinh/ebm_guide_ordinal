"""
train_mlp_bridge_demographics.py
================================
Method 1 (Solution A - Demographics Extended): 
6-Feature MLP Bridge incorporating SuStaIn Subtype & Stage predictions 
along with Subject Age and Sex with Class-Weighted Cross-Entropy Loss.
"""
...
def main():
    ...
    # 2. Merge clinical diagnosis label if missing
    ...
    print(f"Starting 5-Fold Class-Weighted MLP Training (6 Features: SuStaIn + Age + Sex) on folds: {unique_folds}\n")
    ...
    for fold_name in unique_folds:
        ...
        print(f"--- {fold_name.upper()} (Class-Weighted + Age & Sex) ---")
    ...
    print("\n" + "="*70)
    print(" CLASS-WEIGHTED OOF 4-CLASS DIAGNOSTIC SUMMARY (WITH AGE & SEX) ".center(70, "="))
    print("="*70)
    ...
    export_path = os.path.join(output_dir, "mlp_bridge_demographics_4class_predictions.csv")
